...
echo "============================================"
echo "  Pulsar - LLM Attack-Defense CTF"
echo "  Claude Sonnet 4.6 vs GPT-5.3 Codex"
echo "============================================"
echo ""
...
EXPECTED=7  # 6 services + 1 game server
...
echo "  Port Mappings:"
echo "  ┌──────────┬──────────────────┬──────────────────┐"
echo "  │ Service  │ Claude           │ GPT              │"
echo "  ├──────────┼──────────────────┼──────────────────┤"
echo "  │ axis     │ localhost:14000  │ localhost:24000  │"
echo "  │ ico      │ localhost:14265  │ localhost:24265  │"
echo "  │ nilua    │ localhost:18080  │ localhost:28080  │"
echo "  └──────────┴──────────────────┴──────────────────┘"
echo ""
...
echo ""
echo "  Option A — containerized agents (recommended, requires .env with API keys):"
echo "    bash $ROOT_DIR/launch_agents.sh"
echo ""
echo "  Option B — each in a separate terminal (host mode):"
echo "    Terminal 1:  python3 -u $ROOT_DIR/harnesses/claude/agent.py"
echo "    Terminal 2:  bash $ROOT_DIR/harnesses/run_loop.sh gpt"
echo ""
echo "  Option C — all at once on host (backgrounded with logging):"
echo "    bash $ROOT_DIR/launch_agents.sh --host"
echo ""
echo "============================================"
